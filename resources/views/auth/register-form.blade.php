            ...
            <div class="container__child signup__form">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" value="{{ old('name') }}" name="name" id="username"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" value="{{ old('phone_number') }}" name="phone_number"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" value="{{ old('password_confirmation') }}"
                            name="password_confirmation" id="passwordRepeat" placeholder="********" />
                    </div>
